...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/boutique`, lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${BASE}/le-carnet`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/diagnostic`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE}/notre-histoire`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
