  ...
  return (
    <Providers initialLang={lang}>
      ...
      <a
        ...
        className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white pl-3 pr-4 py-3 rounded-full shadow-lg hover:bg-[#1ebe57] transition-colors group"
      >
