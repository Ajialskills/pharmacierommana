export default function ContactPage() {
  return (
    <div style={{ maxWidth: "var(--spacing-max-width)" }} className="mx-auto px-[var(--spacing-lg)] py-12">
      <div className="mb-10">
        <h1 className="text-2xl font-bold text-[var(--color-on-surface)]">Contact</h1>
        <p className="text-sm text-[var(--color-on-surface-variant)] mt-1">Nous sommes disponibles pour répondre à vos questions</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="rounded-2xl overflow-hidden border border-[var(--color-border-subtle)] h-80 md:h-auto">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d537.7808256049897!2d-5.393409205622905!3d35.56700913748666!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b42786c826805%3A0xe57ee821295b7abd!2z2LXZitiv2YTZitipINin2YTYsdmF2KfZhtip!5e0!3m2!1sen!2sma!4v1778582711786!5m2!1sen!2sma"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
