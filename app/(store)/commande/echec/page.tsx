  ...
  return (
    <div style={{ maxWidth: "var(--spacing-max-width)" }} className="mx-auto px-[var(--spacing-lg)] py-20">
      <div className="max-w-[448px] mx-auto text-center">
        ...
        <h1 className="text-2xl font-bold text-[var(--color-on-surface)] mb-3">Paiement non abouti</h1>
        <p className="text-sm text-[var(--color-on-surface-variant)] mb-8 leading-relaxed">
          Votre paiement n&apos;a pas pu être traité. Votre panier a été conservé — vous pouvez réessayer ou choisir un autre mode de paiement.
        </p>
