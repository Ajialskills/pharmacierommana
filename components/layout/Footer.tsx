    ...
    <footer className="bg-white">
      ...
      <div className="border-y border-[var(--color-border-subtle)] bg-[var(--color-surface-container-low)]">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center gap-3 group">
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-[var(--color-on-surface-variant)] mb-1">Adresse</p>
          ...
          >
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-[var(--color-on-surface-variant)] mb-1">WhatsApp</p>
          ...
          <a href="tel:0539714272" className="flex flex-col items-center text-center gap-3 group">
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-[var(--color-on-surface-variant)] mb-1">Téléphone</p>
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          />
          <p className="text-sm text-[var(--color-on-surface-variant)] leading-relaxed max-w-[260px]">
        ...
        {/* Socials */}
        <div>
          <h4 className="text-base font-bold text-[var(--color-on-surface)] mb-5">Réseaux sociaux</h4>
          <ul className="space-y-3">
            {SOCIALS.map((s) => (
              <li key={s.label}>
                ...
                >
                  <span
                    className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-110 transition-transform duration-200"
      ...
      <div className="border-t border-[var(--color-border-subtle)]">
        ...
        >
          <p className="text-xs text-[var(--color-on-surface-variant)]">
            © 2026 PharmacieRommana. All Rights Reserved.
          </p>
